...
public class PaintHouses {
    ...
    /**
     * One of the first dynamic programming problems
     * Problem: https://leetcode.com/problems/paint-house/solution/
     * @param costs
     * @return
     */
    ...
    /**
     * Dynamic Programming approach. In this approach we start bottom up. We
     * store the minimum costs starting from the bottom and find the min in
     * the list in the end
     * @param costs
     * @return
     */
    ...
    /**
     * Recursive tree brute force approach. This is a tree approach where
     * at the end of the tree the code decides to chooses the minimum of the
     * value amongst two houses and continues
     * @param costs
     * @param colourIndex
     * @param houseIndex
     * @return
     ...
     * Recursive tree brute force approach. This is a tree approach where
     * at the end of the tree the code decides to chooses the minimum of the
     * value amongst two houses and continues. This function computes each
     * branch of the tree and does not store the result which means it does not
