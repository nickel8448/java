...
public class BinaryTree {
  ...
  /**
   * Leetcode:
   * https://leetcode.com/explore/interview/card/top-interview-questions-easy/94/trees/555/ Returns
   * the max depth for the tree
   *
   * @return
   */
  public int maxDepth() {
  ...
  /**
   * Leetcode:
   * https://leetcode.com/explore/interview/card/top-interview-questions-easy/94/trees/625/ Checks
   * if the tree is a valid binary search tree Edge case was Both the left and right subtrees must
   * also be binary search trees. So tree - [10,5,15,null,null,6,20] has root at 10 and 6 as a child
   * on the right which doesn't work
   *
   * @return
   */
