...
public class IntersectionOfTwoArrays {
  ...
  /**
   * Problem: https://leetcode.com/problems/intersection-of-two-arrays/solution/ Given two arrays,
  ...
  public static int[] setIntersection(HashSet<Integer> nums1Set, HashSet<Integer> nums2Set) {
  ...
  /**
   * Problem: https://leetcode.com/problems/intersection-of-two-arrays/solution/ Using the inbuilt
   * set functions to get the output and not writing it from scratch
   *
   * @param nums1
   * @param nums2
   * @return
